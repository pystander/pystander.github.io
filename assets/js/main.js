...
// Setting up percentage for skills
...
const typingText = ["A data engineer", "A tech enthusiast", "A quick learner", "A team player"];
...
function type() {
    if (charIndex < typingText[textIndex].length) {
        ...
        typingSpan.textContent += typingText[textIndex].charAt(charIndex);
        charIndex++;
...
function erase() {
    if (charIndex > 0) {
        ...
        typingSpan.textContent = typingText[textIndex].substring(0, charIndex-1);
        charIndex--;
